...
const tracked: Record<string, string[]> = {
  bookings: ["checkIn", "checkOut", "status", "subtotalThb", "discountThb", "discountMode", "discountValue", "totalChargedThb", "creatorCommissionThb", "retainedCommissionThb", "villaNetThb", "commissionMode", "commissionValue", "notes"],
